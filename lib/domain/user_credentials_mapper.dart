...
class UserCredentialsMapper {
  static UserCredentials fromBackend(UserCredentialsAuthService cred) {
    ...
    return UserCredentials(username: cred.login, password: '', firstname: name.first, lastname: name.last);
  }

  static UserCredentialsAuthService fromForm(UserCredentials cred) {
    return UserCredentialsAuthService(cred.username, cred.password, '${cred.firstname} ${cred.lastname}');
  }
}
